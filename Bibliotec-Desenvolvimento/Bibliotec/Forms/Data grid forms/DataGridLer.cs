...
namespace Bibliotec.Forms
{
    public partial class DataGridLer : Form
    {
        ...
        private string Query(string table)
        {
            ...
            1=1";
                ...
                case "tb_emprestimos":
                    ...
                    SELECT 
                        ...
                        tb_exemplar_livro.numero_exemplar AS 'Numero Exemplar Livro',
                        tb_livros.titulo AS 'Titulo do Livro',
                        tb_livros.isbn AS 'ISBN Livro',
                        tb_exemplar_revistas.numero_exemplar AS 'Numero Exemplar Revista',
                        tb_revistas.titulo AS 'Titulo da Revista',
                        tb_trabalhos_graduacao.titulo AS 'Titulo Trabalho Graduação'
                    FROM 
                        tb_emprestimos
                    LEFT JOIN 
                        tb_alunos ON tb_emprestimos.ra_aluno = tb_alunos.ra
                    LEFT JOIN 
                        tb_exemplar_livro ON tb_emprestimos.numero_exemplar_livro = tb_exemplar_livro.numero_exemplar
                    LEFT JOIN 
                        tb_livros ON tb_exemplar_livro.isbn = tb_livros.isbn
                    LEFT JOIN 
                        tb_exemplar_revistas ON tb_emprestimos.numero_exemplar_revista = tb_exemplar_revistas.numero_exemplar
                    LEFT JOIN 
                        tb_revistas ON tb_exemplar_revistas.id_revista = tb_revistas.id
                    LEFT JOIN 
                        tb_trabalhos_graduacao ON tb_emprestimos.id_trabalho_graduacao = tb_trabalhos_graduacao.id
                    WHERE 
                        1=1";
                    break;
            ...
            tb_exemplar_revistas.forma_aquisicao AS 'Forma Aquisição',
